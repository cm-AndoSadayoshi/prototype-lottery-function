...
export function SelectContent({ basePath }: SelectContentProps) {
  const lotteryTypes = [
    {
      id: "gacha",
      name: "ガチャ",
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-[#1A1A2E] to-[#16213E] flex flex-col">
      ...
      <div className="bg-[#1A1A2E]/80 backdrop-blur-sm px-4 py-3 flex items-center gap-3">
        <Link href={`${basePath}/welcome`} className="p-1 hover:bg-white/10 rounded-full">
